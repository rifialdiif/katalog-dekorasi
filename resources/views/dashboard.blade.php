                ...
                <div class="row">
                    <div class="col-xxl-3  col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    @foreach ($jadwal1 as $key => $d)
                                        <h5 class="text-center" id="title-{{ $key + 1 }}"></h5>
                                        <h1 class="text-center" id="timerx-{{ $key + 1 }}"></h1>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="reports-summary">
                                        {{-- @foreach ($jadwal1 as $key => $d)
                                            <div class="reports-summary-block">
                                                <i
                                                    class="bi bi-circle-fill {{ $d->status === 'ongoing'
                                                        ? 'text-success'
                                                        : ($d->status === 'closed'
                                                            ? 'text-danger'
                                                            : ($d->status === 'future'
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6>{{ $d->tanggal_pemilihan }} - <span
                                                            id="timer-{{ $key + 1 }}"></span></h6>
                                                    <h5>{{ $d->judul }}</h5>
                                                </div>
                                            </div>
                                        @endforeach
                                        <a class="btn btn-info download-reports" href="{{ route('calendar') }}">Calendar</a> --}}
                                    </div>
                                </div>
